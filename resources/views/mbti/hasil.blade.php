...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="text-green-900"><b>Profesi</b> :  Penulis, Sastrawan, Konselor, Psikolog, Pengajar, Seniman, Pemuka Agama</p>
        <p class="text-green-900"><b>Partner</b> : ENFJ atau ESFJ</p>
        <p class="text-green-900"><b>Tokoh Terkenal</b> : Audrey Hepburn, J. R. R. Tolkien, Putri Diana, William Shakespeare</p>
        <p class="text-green-900"><b>Pakar ahli : </b>Hikmatun Balighoh Nur Fitriyati., M.Psi.</p>
        <div class="text-right text-green-900 mt-20">

...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="text-green-900"><b>Profesi</b> :  Pengajar, Psikolog, Dokter, Konselor, Pekerja Sosial, Fotografer, Seniman</p>
        <p class="text-green-900"><b>Partner</b> : ESFP atau ESTP</p>
        <p class="text-green-900"><b>Tokoh Terkenal</b> : Plato, Nelson Mandela, George Harrison(The Beatles), Martin Luther King, Jr.</p>

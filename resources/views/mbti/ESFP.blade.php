...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="text-green-900"><b>Profesi</b> : Entertainer, Seniman, Marketing, Konselor, Desainer, Tour Guide</p>
        <p class="text-green-900"><b>Partner</b> : ISTJ atau ISFJ</p>
        <p class="text-green-900"><b>Tokoh Terkenal</b> : Bill Clinton, Pablo Picasso, Woody Harrelson</p>

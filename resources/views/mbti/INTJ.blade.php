...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="text-green-900"><b>Profesi</b> :  Peneliti, Ilmuan, Insinyur, Teknisi, Hakim, Programmer</p>
        <p class="text-green-900"><b>Partner</b> : ENFP atau ENTP</p>
        <p class="text-green-900"><b>Tokoh Terkenal</b> : John F. Kennedy</p>

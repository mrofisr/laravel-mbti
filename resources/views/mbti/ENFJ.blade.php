...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="mt-10 text-lg uppercase text-green-900">Nama : {{ $nama ?? 'NULL' }}</p>
        ...
        <p class="text-green-900"><b>Profesi</b> :  Konsultan, Psikolog, Pengajar, Marketing, Entertainer, Penulis, Motivator</p>
        <p class="text-green-900"><b>Partner</b> : INFP atau ISFP</p>
        <p class="text-green-900"><b>Tokoh Terkenal</b> : Abraham Lincoln, Johnny Depp, Oprah Winfrey, Barack Obama</p>

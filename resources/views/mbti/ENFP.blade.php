...
<body>
    <div class="container w-full mx-auto">
        ...
        <p class="text-green-900"><b>Profesi</b> :  Psikolog, Entertainer, Pengajar, Motivator, Presenter, Reporter, MC, Seniman</p>
        <p class="text-green-900"><b>Partner</b> : INTJ atau INFJ</p>
        <p class="text-green-900"><b>Tokoh Terkenal</b> : Bob Dylan, Will Smith, Robin Williams</p>
